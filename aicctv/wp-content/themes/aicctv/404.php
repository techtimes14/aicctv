                ...
                <?php get_template_part('template-parts/inner', 'banner'); ?>
                    <div class="themify_builder_row module_row clearfix module_row_1 themify_builder_377_row module_row_377-1 tb_je3h81">
                        <div class="row_inner col_align_top">
                            <div class="module_column tb-column first tb_377_column module_column_0 module_column_377-1-0 error_sec">
														...
														<div class="error-404 not-found">
															<span class="errorcode">404</span>
																<header class="page-header">
																	<h2 class="page-title"><?php _e( 'Oops! That page can&rsquo;t be found.', 'twentynineteen' ); ?></h2>
																</header>
														</div>
                                                    </div>
                                                </div>
